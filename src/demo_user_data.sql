...
INSERT INTO `directus_collections` VALUES ('balance_data',1,0,0,NULL,NULL,NULL),('construction_progress',1,0,0,NULL,NULL,NULL),('contracts',1,0,0,NULL,NULL,NULL),('feedback',1,0,0,NULL,NULL,NULL),('funding_reports',1,0,0,NULL,NULL,NULL),('group_info',1,0,0,NULL,NULL,NULL),('group_messages',1,0,0,NULL,NULL,NULL),('imports',1,0,0,NULL,NULL,NULL),('messages',1,1,0,NULL,NULL,NULL),('profiles',1,0,0,NULL,NULL,NULL),('receipts',1,0,0,NULL,NULL,NULL),('transactions',1,0,0,NULL,NULL,NULL);
...
CREATE TABLE `group_messages` (
  ...
  `group` int(10) unsigned DEFAULT NULL,
  `recipients_count` smallint(11) unsigned DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `messages` VALUES (1,'published','2019-01-23 09:32:07','Welcome to BDO realestate','Login is your email.\n\nPassword: `password`\n\n[Profile link](http://)',9,NULL,10,NULL,2,111111),(2,'published','2019-02-24 08:33:22','new test','Hi from developer',6,NULL,NULL,NULL,2,111111);
